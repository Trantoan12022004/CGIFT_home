...
function updateVietQR(amount) {
    ...
    if (amount > 0) {
        ...
        // Tạo ID đơn hàng
        const orderId = 'MHX2025' + Date.now().toString().slice(-6);
        ...
        const vietqrUrl = `https://img.vietqr.io/image/${bankId}-${accountNo}-${template}.png?amount=${amount}&addInfo=${description}&accountName=Phạm%Đức%Hải Triều`;
